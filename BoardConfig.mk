...
TARGET_KERNEL_SOURCE := kernel/onyx/sm6115
TARGET_KERNEL_CONFIG := lineage-onyx_defconfig
...
BOARD_ONYX_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_ext vendor
BOARD_ONYX_DYNAMIC_PARTITIONS_SIZE := 8585740288 # BOARD_SUPER_PARTITION_SIZE - 4MB
BOARD_SUPER_PARTITION_GROUPS := onyx_dynamic_partitions
...
include vendor/onyx/boox/BoardConfigVendor.mk
